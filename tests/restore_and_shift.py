...
data.plot(plot_mode="lin_pol",plot_evpa=True,overplot_clean=True,plot_mask=True)
...
data_convolved.plot(plot_mode="lin_pol",plot_evpa=True,plot_mask=True)
...
data_shifted.plot(plot_mode="lin_pol",plot_evpa=True,overplot_clean=True,plot_mask=True)
